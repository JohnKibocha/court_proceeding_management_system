...
from court_proceedings_management_system.settings import env
from court_proceedings_management_application.models import Transaction
from court_proceedings_management_application.interfaces.mpesa.mpesa_checkout_serializer import TransactionSerializer
...
class MpesaGateWay:
    ...
    def stk_push_request(self, payload):
        ...
        req_data = {
            ...
            "AccountReference": "Court Proceeding Payment",
            "TransactionDesc": "Court Proceeding Payment",
        }
